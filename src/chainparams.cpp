...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("mainnet-seed.rhombus.io");
        vSeeds.emplace_back("dnsseed-mainnet.rhombus.io");
        vSeeds.emplace_back("mainnet.rhombus.io");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.rhombus.io");
        vSeeds.emplace_back("dnsseed-testnet.rhombus.io");
