...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    if (!EnsureWalletIsAvailable(pwallet, request.fHelp)) {
        return NullUniValue;
            ...
            RPCHelpMan{"dumpwallet",
                ...
                {
                    {"filename", RPCArg::Type::STR, RPCArg::Optional::NO, "The filename with path (either absolute or relative to rhombusd)"},
                },
                RPCResult{
            "{                           (json object)\n"
    ...
    if (IsRhombusWallet(pwallet)) {
        ...
        if (!GetRhombusWallet(pwallet)->DumpJson(rv, sError)) {
